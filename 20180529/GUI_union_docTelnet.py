    ...
    def DownloadFileInWord(self):
        ...
        if self.wordfile:
            ...
            for file_typex in self.sucess_file:
                if (file_typex[0]=='bootrom')and(file_typex[1][-3:]=='bin')and('no_header' not in file_typex[1]):
...
#close
    ...
    def createWidgets(self):
        ...
        self.Menubar.add_cascade(label=u'配置保存',menu=self.fileMenu)
        ...
        self.Menubar.add_cascade(label='配置加载',menu=self.EditMenu)
...
#============card name
        ...
        self.DevAddCardLabel=Label(self.DevCardNameLabel_Father,text=u'板卡名称:',bg='#9ACD32',width=15,height=3)#width=15, height=5
...
#============ti ce dan word file
        self.DevWordLabel=Label(self.DevCardNameLabel_Father,text=u'提测单名:',bg='#9ACD32',width=15,height=3)#width=15, height=5
