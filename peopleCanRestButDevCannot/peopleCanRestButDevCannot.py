...
class peopleCanRestButDevCannot(Frame):
    global window
    window=Tk()
    def __init__(self,master=None):
        ...
        self.pack()
        self.createWidgets()
        self.log_path=r'D:\py_ftp_download\peopleCanRestButDevCannot\\'
    ...
    def RemoveFromGenerateOPlistList(self,event):#DevGenerateOPlistListbox
        try:
            self.DevGenerateOPlistListbox.delete(int(self.DevGenerateOPlistListbox.curselection()[0]))
        except Exception as e:
            print(u'已选操作列表为空或者你点偏了！又或者你鼠标没动，一直在双击！')
    ...
    def createWidgets(self):
        self.DevUPSideLabel_Father=Label(self,width=100,height=28)#上半部分基底（28）
        self.DevUPSideLabel_Father.pack(side=TOP,expand='no')
        self.DevDOWNSideLabel_Father=Label(self,width=100,height=20)#下半部分基底（20）
        self.DevDOWNSideLabel_Father.pack(side=BOTTOM,expand='yes')
        
        self.DevALLOPLabel_Father=Label(self.DevUPSideLabel_Father,width=44,height=28)#可选操作列表基底
        self.DevALLOPLabel_Father.pack(side=LEFT,expand='no',anchor='nw')
        self.DevAddOPLabel_Father=Label(self.DevUPSideLabel_Father,width=10,height=28)#添加用的中间栏基底
        self.DevAddOPLabel_Father.pack(side=LEFT,expand='yes',anchor='nw')
        self.DevOPViewLabel_Father=Label(self.DevUPSideLabel_Father,width=44,height=28)#构建操作序列的列表基底
        ...
        self.DevOPTimes_title2=Label(self.DevAddOPLabel_Father,width=15,height=1)
        ...
        #配置操作次数
        self.DevOPTimesLabel_Father=Label(self.DevAddOPLabel_Father,width=12,height=14)#添加用的中间栏基底
        ...
        #设置主循环次数
        self.DevSetMainLoopTimesLabel=Label(self.DevAddedOPListLabel_Father,width=43,height=1)#设置主循环次数基底
        ...
        #设置主循环次数-标题
        self.DevSetMainLoopTimesLabel_title=Label(self.DevSetMainLoopTimesLabel,text=u'主循环次数(0代表无限循环)',width=23,height=1)#设置主循环次数基底
        ...
        self.DevGenerateOPlistListbox.bind('<Double-Button-1>',self.RemoveFromGenerateOPlistList)
